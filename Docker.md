...
## О Docker-образах
Docker-образы устроены таким способом, что все важные данные вынесенны в общие с хостовой машиной папки. Поэтому вы можете смело останавливать, удалять и создавать новые контейнеры.
...
Если вам необходимо внести изменения в образ, то войдите в контейнер, внестите изменения и затем сделайте коммит в ваш образ командой
